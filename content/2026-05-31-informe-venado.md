...
Durante tres días realizamos un trabajo de capacitación co-organizada por Maná, Choique, Municipalidad de Venado Tuerto, el Insituto Católico de Enseñanza Superior (ICES) y Cáritas Venado Tuerto. Y brindada en el marco de las actividades del programa de Embajadores Comunitarios de UN Mappers, del que soy representante en Argentina. Nos enfocamos en dos tipos de mapeo, remoto (usando ID Editor en OSM) y en campo (usando SketchMap Tool y ChatMap). El objetivo, de este trabajo consistía en mejorar el mapa de la zona sur de la ciudad (Barrio Villa Moisés y Esfuerzo Propio) para realizar un trabajo integral de prevención de inundaciones.

Las actividades descriptas, se llevaron adelante el día Sábado, dedicado exclusivamente al trabajo de relevamiento.
...
![Fotografía del mapeo en papel realizado con vecinas, foto: Bastian Greshake Tzovaras](https://live.staticflickr.com/65535/55302918952_a555351c26_6k.jpg)

![SketchMap Tool de Barrio Esfuerzo Propio y Villa Moises](https://live.staticflickr.com/65535/55359316100_712e96eb59_b.jpg)
...
Resumen de datos relevados:
* Luminarias: 60 puntos
* Arbolado 27 puntos
* Mini basurales y desagües: 80 puntos
* Estado de las calles: 9 puntos

Finalmente, luego de consolidar, analizar y clasificar los datos, se produjo el siguiente [uMap](https://umap.hotosm.org/en/map/mapa-del-barrio-esfuerzo-propio-asentamiento-villa_3111)
...
Las calles con mayor deterioro con Eva Perón y Marenghini. Particular esta última fue objeto de reparaciones por parte de los vecinos (con elementos de relleno, en especial de material de obra) que dificultaron aún más la circulación. 
Las zonas con presencia de árboles en calles Perón, Berti, Carelli y Pasaje Río V podría corresponderse con el plan de árboles entregados por Maná. Esto es una presunción que debería comprobarse.
...
Una etapa igualmente importante consiste en la devolución de los resultados a la comunidad y a las organizaciones que participaron del relevamiento. 
